...
public class layout2 {
    ...
    Activity activity;
    TextView t1,t2;
    public View ViewQunliao(Activity activity) {
        this.activity = activity;
        View view = View.inflate(activity.getApplicationContext(), R.layout.layout2, null);
        initData();
        list = view.findViewById(R.id.la2);
    ...
    class ExAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            t1.setText("群聊" + groupPosition + "号");
            t2.setText("群聊" + groupPosition + "号");
            return view;
        }
